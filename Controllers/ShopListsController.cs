...
namespace Ciurea_Cosmin_Lab11.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Ciurea_Cosmin_Lab11Context _context;

        public ShopListsController(Ciurea_Cosmin_Lab11Context context)
        {
            _context = context;
        }
